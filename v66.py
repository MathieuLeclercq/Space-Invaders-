# -*- coding: utf-8 -*-
from tkinter import * # obligatoire ?
class Ennemi:
    def __init__(self, setimage, fcanvas, directionLeft = True, positionx=52, positiony=28, kind=1):
...
class Player:
    def __init__(self, image, fcanvas, positionx=52, positiony=28, direction = 0):
